INSERT INTO cause(id, description, binary_identifier) VALUES
(nextval('cause_sequence'), 'Saúde', 2),
...
(nextval('cause_sequence'), 'Jovens', 4096);
...
(nextval('skill_sequence'), 'Idiomas', 32768);
